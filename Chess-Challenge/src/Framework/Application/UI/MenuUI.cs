    ...
    public static class MenuUI
    {
        ...
        public static void DrawButtons(ChallengeController controller)
        {
           ...
           // buttonPos = UIHelper.Scale(new Vector2(1020, 210)); buttonSize = UIHelper.Scale(new Vector2(200, 55));
            ...
            if (NextButtonInRow("vs QsearchV2", ref buttonPos, spacing, buttonSize)) {
                controller.StartNewBotMatch(ChallengeController.PlayerType.MyBot, ChallengeController.PlayerType.MyQsearchV2);
            }
