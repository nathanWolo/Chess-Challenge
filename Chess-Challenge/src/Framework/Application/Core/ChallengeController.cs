...
public static ChessChallenge.API.IChessBot? CreateBot(PlayerType type)
{
    return type switch
    {
        ...
        PlayerType.Onion46 => new Onion46(),
        PlayerType.Onion5 => new Onion5(),
        PlayerType.Onion51 => new Onion51(),
        PlayerType.Onion6 => new Onion6(),
        PlayerType.Onion7 => new Onion7(),
        PlayerType.Onion71 => new Onion71(),
        PlayerType.Onion72 => new Onion72(),
        PlayerType.Onion73 => new Onion73(),
        PlayerType.Onion74 => new Onion74(),
        PlayerType.Onion75 => new Onion75(),
        PlayerType.Onion76 => new Onion76(),
        PlayerType.Onion77 => new Onion77(),
        PlayerType.Onion78 => new Onion78(),
        PlayerType.Onion8 => new Onion8(),
        PlayerType.Onion81 => new Onion81(),
        PlayerType.Onion82 => new Onion82(),
        ...
        PlayerType.TyrantLatest => new TyrantLatest(),
        ...
        ChessPlayer CreatePlayer(PlayerType type)
        {
            return type switch
            {
                ...
                PlayerType.Onion46 => new ChessPlayer(new Onion46(), type, GameDurationMilliseconds),
                PlayerType.Onion5 => new ChessPlayer(new Onion5(), type, GameDurationMilliseconds),
                PlayerType.Onion51 => new ChessPlayer(new Onion51(), type, GameDurationMilliseconds),
                PlayerType.Onion6 => new ChessPlayer(new Onion6(), type, GameDurationMilliseconds),
                PlayerType.Onion7 => new ChessPlayer(new Onion7(), type, GameDurationMilliseconds),
                PlayerType.Onion71 => new ChessPlayer(new Onion71(), type, GameDurationMilliseconds),
                PlayerType.Onion72 => new ChessPlayer(new Onion72(), type, GameDurationMilliseconds),
                PlayerType.Onion73 => new ChessPlayer(new Onion73(), type, GameDurationMilliseconds),
                PlayerType.Onion74 => new ChessPlayer(new Onion74(), type, GameDurationMilliseconds),
                PlayerType.Onion75 => new ChessPlayer(new Onion75(), type, GameDurationMilliseconds),
                PlayerType.Onion76 => new ChessPlayer(new Onion76(), type, GameDurationMilliseconds),
                PlayerType.Onion77 => new ChessPlayer(new Onion77(), type, GameDurationMilliseconds),
                PlayerType.Onion78 => new ChessPlayer(new Onion78(), type, GameDurationMilliseconds),
                PlayerType.Onion8 => new ChessPlayer(new Onion8(), type, GameDurationMilliseconds),
                PlayerType.Onion81 => new ChessPlayer(new Onion81(), type, GameDurationMilliseconds),
                PlayerType.Onion82 => new ChessPlayer(new Onion82(), type, GameDurationMilliseconds),
                ...
                PlayerType.TyrantLatest => new ChessPlayer(new TyrantLatest(), type, GameDurationMilliseconds),
