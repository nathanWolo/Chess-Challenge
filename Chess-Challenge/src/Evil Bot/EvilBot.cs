...
public class Onion81 : IChessBot
{
...
public class Onion78 : IChessBot
{
...
public class Onion77 : IChessBot
{
...
public class Onion76 : IChessBot
{
...
public class Onion75 : IChessBot
{
...
public class Onion74 : IChessBot
{
    ...
    */
    ...
    public int PVS(int depthLeft, int depthSoFar, int alpha, int beta)
    {
        ...
        while (++moveIndex < numMoves) {
            ...
            //this way our increment is always executed
            //late move reduction condition
            if(canFutilityPrune && scores[moveIndex] == 0) //can fp is only set to true in a not PV, not Qsearch if block, so safe to have it here.
                    //scores[moveIndex] == 0 asserts that the move is quiet and hasnt caused beta cutoffs in the past
                    continue;
...
public class Onion73 : IChessBot
{
...
public class Onion72 : IChessBot
{
    ...
    */
    ...
    public int PVS(int depthLeft, int depthSoFar, int alpha, int beta)
    {
        ...
        if(qsearch) {
            ...
            //reverse futility pruning
            //Basic idea: if your score is so good you can take a big hit and still get the beta cutoff, go for it.
            if (standPat - 150 * depthLeft >= beta && depthLeft < 8) //TODO: tune this constant.
                return beta; //fail hard, TODO: try fail soft
  ...
  public class Onion71 : IChessBot
{
...
public class Onion7 : IChessBot
{
    ...
    */
    ...
    public int NegaMax(int depthLeft, int depthSoFar, int alpha, int beta)
    {
        ...
        else if (depthLeft > 2 && !inCheck && notRoot && beta - alpha == 1){ //null move pruning
            globalBoard.ForceSkipTurn();
        ...
        //reverse futility pruning
        //Basic idea: if your score is so good you can take a big hit and still get the beta cutoff, go for it.
        else if (standPat - 150 * depthLeft >= beta && depthLeft < 8 && beta - alpha == 1) { //TODO: tune this constant.
            return beta; //fail hard, TODO: try fail soft
        }
        ...
        while (++moveIndex < numMoves) {
            ...
            if (moveIndex == 0 || qsearch) {
                ...
                //futility pruning
                if(depthLeft <= 8 && standPat + depthLeft * 225 <= alpha && beta - alpha == 1) {
                    globalBoard.UndoMove(move);
                    continue;
                }
...
public class Onion51 : IChessBot
{
...
public class Onion44 : IChessBot
{
    struct TTEntry {
        public ulong key; //64 bits
        public Move move; //
...
public class Onion43 : IChessBot
{
    struct TTEntry {
        public ulong key; //64 bits
        public Move move; //
        ...
        for (int i = 0; i < legalMoves.Length; i++) {
            ...
            */
            scores[i] = (legalMoves[i] == entry.move && entry.key == key) ? -999999 : //TT move
                ...
                // killerTable[depthSoFar] == legalMoves[i] ? -500 : //killers
...
public class Onion42 : IChessBot
{
    struct TTEntry {
        public ulong key; //64 bits
        public Move move; //
...
public class TyrantLatest : IChessBot
{
    // Pawn, Knight, Bishop, Rook, Queen, King 
