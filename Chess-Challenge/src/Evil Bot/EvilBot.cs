    ...
    */
    ...
    public int PVS(int depthLeft, int depthSoFar, int alpha, int beta)
    {
        ...
        if(qsearch) {
            ...
            else if (standPat - 125 * depthLeft >= beta && depthLeft < 10)  //TODO: tune this constant.
        ...
        moveIndex = -1;
        while (++moveIndex < numMoves) {
            if(depthLeft <= 10 && standPat + depthLeft * 160 <= alpha && notPV && !qsearch && moveIndex > 0)
...
public class Onion71 : IChessBot
{
    ...
    */
    ...
    public int PVS(int depthLeft, int depthSoFar, int alpha, int beta)
    {
        ...
        moveIndex = -1;
        while (++moveIndex < numMoves) {
            if(depthLeft <= 8 && standPat + depthLeft * 225 <= alpha && notPV && !qsearch && moveIndex > 0)
                    continue; //futility pruning
            Move move = legalMoves[moveIndex];
            //late move reduction condition
            bool canLMR = moveIndex > 4 && depthLeft > 3 && scores[moveIndex] == 0;
